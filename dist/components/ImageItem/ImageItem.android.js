 ...
 */
 ...
 import useImageDimensions from "expo-cached-image-viewing/dist/hooks/useImageDimensions";
 import usePanResponder from "expo-cached-image-viewing/dist/hooks/usePanResponder";
 import { getImageStyles, getImageTransform } from "expo-cached-image-viewing/dist/utils";
 import { ImageLoading } from "expo-cached-image-viewing/dist/components/ImageItem/ImageLoading";
 import CachedImage from "expo-cached-image-viewing/dist/components/ImageItem/CachedImage";
 ...
 const ImageItem = ({ imageSrc, onZoom, onRequestClose, onLongPress, delayLongPress, swipeToCloseEnabled = true, doubleTapToZoomEnabled = true, }) => {
     ...
     cacheKey={imageSrc.cacheKey} style={imageStylesWithOpacity} onLoad={() => {console.log('image loaded1');setLoaded(true)}}/>
     </ScrollView>
     </View>
     );
 };
